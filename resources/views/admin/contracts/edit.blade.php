                                ...
                                <div class="app_collapse_content">
                                    <div class="label_g2">
                                        <label class="label">
                                            ...
                                            <select class="select2" name="acquirer"
                                ...
                                <div class="app_collapse_content">
                                    ...
                                    <div class="label_g2">
                                        <label class="label">
                                            ...
                                            <input type="text" name="sale_price" class="mask-money"
                                                   placeholder="Valor de Venda"
                                                   value="{{ ($contract->sale == true ? $contract->price : '0.00') }}" {{ ($contract->sale != true ? 'disabled' : '') }}/>
                                        </label>
                                        ...
                                        <label class="label">
                                            ...
                                            <input type="text" name="rent_price" class="mask-money"
                                                   ...
                                                   value="{{ ($contract->rent == true ? $contract->price : '0.00') }}" {{ ($contract->rent != true ? 'disabled' : '') }}/>
                                        </label>
                                    </div>
                                    ...
                                    <div class="label_g2">
                                        <label class="label">
                                            ...
                                            <select name="due_date"
                                                    {{ (old('rent') != 'on' ? 'disabled' : '') }} class="select2">
...
@section('js')
    <script>
        ...
        $(function () {
            ...
            /* Funções de gatilhos Proprietario, Adiquirente e Contratos */
            function setFieldOwner(response) {

                //Seleção Proprietario - Conjuge
                ...
                //Seleção Proprietario - Companias
            ...
            /*Fim funções de gatilho */

            //alert('teste');

            //Gatilho Ajax - Proprietario
            ...
            //Gatilho Ajax - Seleção Adiquirente
