            ...
            <div class="dash_content_app_header_actions">
                <nav class="dash_content_app_breadcrumb">
                    <ul>
                        ...
                        <li class="separator icon-angle-right icon-notext"></li>
                        <li><a href="{{ route('admin.users.create') }}" class="text-orange">Editar Cliente</a></li>
                    </ul>
                </nav>
            </div>
        </header>
                    ...
                    <div class="nav_tabs_content">
                        <div id="data">
                            <div class="label_gc">
                                ...
                                <label class="label">
                                    <input type="checkbox"
                                           name="lessee" {{ old('lessee') == 'on' || old('lesse') == true ? 'checked' : ($user->lessee == true ? 'checked' : '')}}><span>Locador</span>
                                </label>
                            </div>
                                ...
                                <label class="label">
                                    ...
                                    <select name="civil_status">
                                        ...
                                        <optgroup label="Cônjuge não Obrigatório">
                                            ...
                                            <option
                                                value="divorced" {{ old('civil_status') == 'separated' ? 'selected' : ($user->civil_status == 'separated' ? 'selected' : '')}}>
                                                Divorciado
                                            </option>
                                            <option
                                ...
                                <div class="app_collapse_content d-none content_spouse">
                                    ...
                                    <label class="label">
                                        ...
                                        <select name="type_of_communion" class="select2">
                                            <option
                                                value="Comunhão Universal de Bens" {{ old('type_of_commuion') == 'Comunhão Universal de Bens' ? 'selected' : ($user->type_of_communion == 'Comunhão Universal de Bens' ? 'selected' : '') }}>
                                                Comunhão Universal de Bens
                                            </option>
                                            <option
                                                value="Comunhão Parcial de Bens" {{ old('type_of_commuion') == 'Comunhão Parcial de Bens' ? 'selected' : ($user->type_of_communion == 'Comunhão Parcial de Bens' ? 'selected' : '')}}>
                                                Comunhão Parcial de Bens
                                            </option>
                                            <option
                                                value="Separação Total de Bens" {{ old('type_of_commuion') == 'Separação Total de Bens' ? 'selected' : ($user->type_of_communion == 'Separação total de Bens' ? 'selected' : '') }}>
                                                Separação Total de Bens
                                            </option>
                                            <option
                                                value="Participação Final de Aquestos" {{ old('type_of_commuion') == 'Participação Final de Aquestos' ? 'selected' : ($user->type_of_communion == 'Participação Final de Aquestos' ? 'selected' : '') }}>
                            ...
                            <div class="app_collapse mt-2">
                                ...
                                <div class="app_collapse_content">
                                    ...
                                    <div class="companies_list">
                                        @if($user->companiesUser()->get())
                                            @foreach($user->companiesUser()->get() as $company)
                                                <div class="companies_list_item mb-2">
                                                    ...
                                                    <p><b>CNPJ:</b> {{$company->document_company}} - <b>Inscrição
                                                            Estadual:</b>{{ $company->document_company_secundary }}</p>
                                ...
                                <div class="app_collapse_content">
                                    <div id="realties">
                                        <div class="realty_list">
                                            @if($user->propertiesUser()->get())
                                                @foreach($user->propertiesUser()->get() as $property)
                                                    {{--{{ $property->coverImage() }}--}}
