                    ...
                    <div class="nav_tabs_content">
                        <div id="data">
                            <div class="label_gc">
                                ...
                                <label class="label">
                                    <input type="checkbox" name="lessee" {{ old('lessee') == 'on' || old('lesse') == true ? 'checked' : '' }}><span>Locador</span>
                                </label>
                            </div>
                                ...
                                <label class="label">
                                    ...
                                    <select name="civil_status">
                                        ...
                                        <optgroup label="Cônjuge não Obrigatório">
                                            ...
                                            <option value="divorced" {{ old('civil_status') == 'separated' ? 'selected' : '' }}>Divorciado</option>
                                ...
                                <div class="app_collapse_content d-none content_spouse">
                                    ...
                                    <label class="label">
                                        ...
                                        <select name="type_of_communion" class="select2">
                                            <option value="Comunhão Universal de Bens" {{ old('type_of_commuion') == 'Comunhão Universal de Bens' ? 'selected' : '' }}>Comunhão Universal de Bens</option>
                                            <option value="Comunhão Parcial de Bens" {{ old('type_of_commuion') == 'Comunhão Parcial de Bens' ? 'selected' : '' }}>Comunhão Parcial de Bens</option>
                                            <option value="Separação Total de Bens" {{ old('type_of_commuion') == 'Separação Total de Bens' ? 'selected' : '' }}>Separação Total de Bens</option>
                                            <option value="Participação Final de Aquestos" {{ old('type_of_commuion') == 'Participação Final de Aquestos' ? 'selected' : '' }}>Participação Final de Aquestos
                                            </option>
                                        </select>
                                    </label>
