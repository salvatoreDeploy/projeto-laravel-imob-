...
<<<<<<< HEAD
                                        ...
                                        <option
                                            value="Comercial/Industrial" {{ (old('category') == 'Comercial/Industrial' ? 'selected' : ($property->commercial_industrial == 'Comercial/Industrial' ? 'selected' : '')) }}>
                                ...
                                <label class="label">
                                    ...
                                    <select name="type" class="select2">
                                        <optgroup label="Imóvel Residencial">
                                            ...
                                            <option
                                                value="roof" {{ (old('type') == 'Cobertura' ? 'selected' : ($property->type == 'Cobertura' ? 'selected' : '')) }}>
                                                Cobertura
                                            </option>
                                            <option
                        ...
                        <div id="structure" class="d-none">
                            ...
                            <div class="label_g5">
                                <div>
                                    <label class="label">
                                        <input type="checkbox"
                                               name="air_conditioning" {{ (old('air_conditioning') == 'on' || old('sale') == true ? 'checked' : ($property->air_conditioning == true ? 'checked' : '')) }}><span>Ar Condicionado</span>
                                    </label>
                                </div>
                                <div>
                                    <label class="label">
                                        <input type="checkbox"
                                               name="bar" {{ (old('bar') == 'on' || old('sale') == true ? 'checked' : ($property->bar == true ? 'checked' : '')) }}><span>Bar</span>
                                    </label>
                                </div>
                                <div>
                                    <label class="label">
                                        <input type="checkbox"
                                               name="library" {{ (old('library') == 'on' || old('sale') == true ? 'checked' : ($property->library == true ? 'checked' : '')) }}><span>Biblioteca</span>
                                    </label>
                                </div>
                                ...
                                <div>
                                    <label class="label">
                                        <input type="checkbox"
                                               name="barbecue_grill" {{ (old('barbecue_grill') == 'on' || old('sale') == true ? 'checked' : ($property->barbecue_grill == true ? 'checked' : '')) }}><span>Churrasqueira</span>
                                    </label>
                                </div>
                                ...
                                <div>
                                    <label class="label">
                                        <input type="checkbox"
                                               name="american_kitchen" {{ (old('american_kitchen') == 'on' || old('sale') == true ? 'checked' : ($property->american_kitchen == true ? 'checked' : '')) }}><span>Cozinha Americana</span>
                                    </label>
                                </div>
                                ...
                                <div>
                                    <label class="label">
                                        <input type="checkbox"
                                               name="fitted_kitchen" {{ (old('fitted_kitchen') == 'on' || old('sale') == true ? 'checked' : ($property->fitted_kitchen == true ? 'checked' : '')) }}><span>Cozinha Planejada</span>
                                    </label>
                                </div>
                                <div>
                                    <label class="label">
                                        <input type="checkbox"
                                               name="pantry" {{ (old('pantry') == 'on' || old('sale') == true ? 'checked' : ($property->pantry == true ? 'checked' : '')) }}><span>Despensa</span>
                                    </label>
                                </div>
                                ...
                                <div>
                                    <label class="label">
                                        <input type="checkbox"
                                               name="edicule" {{ (old('edicule') == 'on' || old('sale') == true ? 'checked' : ($property->edicule == true ? 'checked' : '')) }}><span>Edícula</span>
                                    </label>
                                </div>
                                ...
                                <div>
                                    <label class="label">
                                        <input type="checkbox"
                                               name="office" {{ (old('office') == 'on' || old('sale') == true ? 'checked' : ($property->office == true ? 'checked' : '')) }}><span>Escritório</span>
                                    </label>
                                </div>
                                <div>
                                    <label class="label">
                                        <input type="checkbox"
                                               name="bathtub" {{ (old('bathtub') == 'on' || old('sale') == true ? 'checked' : ($property->bathtub == true ? 'checked' : '')) }} ><span>Banheira</span>
                                    </label>
                                </div>
                                <div>
                                    <label class="label">
                                        <input type="checkbox"
                                               name="fireplace" {{ (old('fireplace') == 'on' || old('sale') == true ? 'checked' : ($property->fireplace == true ? 'checked' : '')) }}><span>Lareira</span>
                                    </label>
                                </div>
                                <div>
                                    <label class="label">
                                        <input type="checkbox"
                                               name="lavatory" {{ (old('lavatory') == 'on' || old('sale') == true ? 'checked' : ($property->lavatory == true ? 'checked' : '')) }}><span>Lavabo</span>
                                    </label>
                                </div>
                                <div>
                                    <label class="label">
                                        <input type="checkbox"
                                               name="furnished" {{ (old('furnished') == 'on' || old('sale') == true ? 'checked' : ($property->furnished == true ? 'checked' : '')) }}><span>Mobiliado</span>
                                    </label>
                                </div>
                                <div>
                                    <label class="label">
                                        <input type="checkbox"
                                               name="pool" {{ (old('pool') == 'on' || old('sale') == true ? 'checked' : ($property->pool == true ? 'checked' : '')) }} ><span>Piscina</span>
                                    </label>
                                </div>
                                <div>
                                    <label class="label">
                                        <input type="checkbox"
                                               name="steam_room" {{ (old('steam_room') == 'on' || old('sale') == true ? 'checked' : ($property->steam_room == true ? 'checked' : '')) }}><span>Sauna</span>
                                    </label>
                                </div>
                                <div>
                                    <label class="label">
                                        <input type="checkbox"
                                               name="view_of_the_sea" {{ (old('view_of_the_sea') == 'on' || old('sale') == true ? 'checked' : ($property->view_of_the_sea == true ? 'checked' : '')) }}><span>Vista para o Mar</span>
                                    </label>
                                </div>
                            </div>
                    ...
                    <div id="images" class="d-none">
                        ...
                        <div class="content_image">
                            ...
                            <div class="property_image">
                                @foreach($property->imagesUser()->get() as $image)
                                    <div class="property_image_item">
                                        <img src="{{ $image->url_cropped }}" alt="">
                                        <div class="property_image_actions">
                                            <a href="javascript:void(0)" class="btn btn-small {{ ($image->cover == true ? 'btn-green' : '') }} icon-check icon-notext imageSetCover" data-action="{{ route("admin.properties.setImageCover", ['image' => $image->id]) }}"></a>
                                            <a href="javascript:void(0)" class="btn btn-red btn-small icon-times icon-notext imageRemove" data-action="{{ route("admin.properties.imageRemove",['image' => $image->id]) }}"></a>
                                        </div>
                                    </div>
                                @endforeach
                            </div>
...
@section('js')
    <script>
        $(function () {
            ...
            $('.imageSetCover').click(function (event){
