                        ...
                        <div id="structure" class="d-none">
                            ...
                            <div class="label_g5">
                                <div>
                                    <label class="label">
                                        <input type="checkbox"
                                               name="air_conditioning" {{ (old('air_conditioning') == 'on' || old('sale') == true ? 'checked' : '') }}><span>Ar Condicionado</span>
                                    </label>
                                </div>
                                <div>
                                    <label class="label">
                                        <input type="checkbox"
                                               name="bar" {{ (old('bar') == 'on' || old('sale') == true ? 'checked' : '') }}><span>Bar</span>
                                    </label>
                                </div>
                                <div>
                                    <label class="label">
                                        <input type="checkbox"
                                               name="library" {{ (old('library') == 'on' || old('sale') == true ? 'checked' : '') }}><span>Biblioteca</span>
                                    </label>
                                </div>
                                ...
                                <div>
                                    <label class="label">
                                        <input type="checkbox"
                                               name="barbecue_grill" {{ (old('barbecue_grill') == 'on' || old('sale') == true ? 'checked' : '') }}><span>Churrasqueira</span>
                                    </label>
                                </div>
                                ...
                                <div>
                                    <label class="label">
                                        <input type="checkbox"
                                               name="american_kitchen" {{ (old('american_kitchen') == 'on' || old('sale') == true ? 'checked' : '') }}><span>Cozinha Americana</span>
                                    </label>
                                </div>
                                ...
                                <div>
                                    <label class="label">
                                        <input type="checkbox"
                                               name="fitted_kitchen" {{ (old('fitted_kitchen') == 'on' || old('sale') == true ? 'checked' : '') }}><span>Cozinha Planejada</span>
                                    </label>
                                </div>
                                <div>
                                    <label class="label">
                                        <input type="checkbox"
                                               name="pantry" {{ (old('pantry') == 'on' || old('sale') == true ? 'checked' : '') }}><span>Despensa</span>
                                    </label>
                                </div>
                                ...
                                <div>
                                    <label class="label">
                                        <input type="checkbox"
                                               name="edicule" {{ (old('edicule') == 'on' || old('sale') == true ? 'checked' : '') }}><span>Edícula</span>
                                    </label>
                                </div>
                                ...
                                <div>
                                    <label class="label">
                                        <input type="checkbox"
                                               name="office" {{ (old('office') == 'on' || old('sale') == true ? 'checked' : '') }}><span>Escritório</span>
                                    </label>
                                </div>
                                <div>
                                    <label class="label">
                                        <input type="checkbox"
                                               name="bathtub" {{ (old('bathtub') == 'on' || old('sale') == true ? 'checked' : '') }} ><span>Banheira</span>
                                    </label>
                                </div>
                                <div>
                                    <label class="label">
                                        <input type="checkbox"
                                               name="fireplace" {{ (old('fireplace') == 'on' || old('sale') == true ? 'checked' : '') }}><span>Lareira</span>
                                    </label>
                                </div>
                                <div>
                                    <label class="label">
                                        <input type="checkbox"
                                               name="lavatory" {{ (old('lavatory') == 'on' || old('sale') == true ? 'checked' : '') }}><span>Lavabo</span>
                                    </label>
                                </div>
                                <div>
                                    <label class="label">
                                        <input type="checkbox"
                                               name="furnished" {{ (old('furnished') == 'on' || old('sale') == true ? 'checked' : '') }}><span>Mobiliado</span>
                                    </label>
                                </div>
                                <div>
                                    <label class="label">
                                        <input type="checkbox"
                                               name="pool" {{ (old('pool') == 'on' || old('sale') == true ? 'checked' : '') }} ><span>Piscina</span>
                                    </label>
                                </div>
                                <div>
                                    <label class="label">
                                        <input type="checkbox"
                                               name="steam_room" {{ (old('steam_room') == 'on' || old('sale') == true ? 'checked' : '') }}><span>Sauna</span>
                                    </label>
                                </div>
                                <div>
                                    <label class="label">
                                        <input type="checkbox"
                                               name="view_of_the_sea" {{ (old('view_of_the_sea') == 'on' || old('sale') == true ? 'checked' : '') }}><span>Vista para o Mar</span>
                                    </label>
                                </div>
                            </div>
