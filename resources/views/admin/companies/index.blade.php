                ...
                <table id="dataTable" class="nowrap hover stripe" width="100" style="width: 100% !important;">
                    ...
                    @foreach($companies as $company)
                        <tr>
                            ...
                            <td>{{ $company->document_company_secundary }}</td>
                            <td><a href="{{ route('admin.users.edit', ['user' => $company->userCompanies()->first()->id]) }}" class="text-orange">{{ $company->userCompanies()->first()->name }}</a></td>
                        </tr>
                    @endforeach
                    </tbody>
                </table>
