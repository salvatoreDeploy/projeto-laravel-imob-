            ...
            <div class="dash_content_app_box_stage">
                <form class="app_form" action="{{ route('admin.companies.store') }}" method="post">
                    ...
                    <label class="label">
                        ...
                        <select id="selecao" name="user" class="select2">
                    ...
                    <div class="label_g2">
                        ...
                        <label class="label">
                            ...
                            <input type="text" name="document_company_secundary" placeholder="Número da Inscrição"
                                   value="{{ old('document_company_secundary') }}""/>
                        </label>
                    </div>
