                    ...
                    <div class="col-12 col-lg-8">
                        <div id="carouselProperty" class="carousel slide" data-ride="carousel">
                            <ol class="carousel-indicators">
                                @if($property->imagesUser()->get()->count())
...
@section('js')
    <script>
        ...
        function markMap() {
            ...
            var locationJson = $.getJSON('https://maps.googleapis.com/maps/api/geocode/json?address={{ $property->street }},+{{ $property->number }}+{{ $property->city }}+{{ $property->neighborhood }}&key=AIzaSyBm_GcxOF9S6wPSNt9sMleqLyT6Bv96Iio', function (response) {
